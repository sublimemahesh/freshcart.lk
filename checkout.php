                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-ms-12">
                                        <div class="check-address">
                                            <form class="form-my-account">
                                                <p>
                                                    <textarea cols="30" rows="9">Order Notes</textarea>
                                                </p>
                                            </form>
                                        </div>		
                                    </div>
                                ...
                                <div class="woocommerce-checkout-review-order" id="order_review">
                                                ...
                                                foreach ($_SESSION["shopping_cart"] as $product) {
                                                    ...
                                                    <tr class="cart_item">
                                                        <td class="product-name">
                                                            <?php echo $PRODUCT->name; ?>&nbsp; <span class="product-quantity">× <?php echo $product['product_price']; ?></span>
                                                        </td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="place-order-btn">
                                            <input type="hidden" id="total_amount" value="115000">
                                            <button data-value="Place order" id="place_order" name="woocommerce_checkout_place_order" class="button alt">Place order</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
