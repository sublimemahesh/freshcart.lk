...
//    public function getAllProducts($minimum_price, $maximum_price, $page, $per_page) {
...
//    }
    ...
    public function getAllProductsByCategoryAndBrand($category, $minimum_price, $maximum_price, $sub_category, $brand, $page, $per_page) {
        ...
        if (!empty($sub_category)) {
            $sub_category_filter = implode(",", $sub_category);
            $w[] = '`sub_category` in(' . $sub_category_filter . ')';
        }
...
//            $query .= ' ORDER BY  queue DESC LIMIT ' . $page . ',' . $per_page . '';
    ...
    public function getMaxPriceInProduct1($category, $sub_category, $brand) {
    ...
    public function getMinPriceInProduct1($category, $sub_category, $brand) {
    ...
    public function search($category, $keyword, $pageLimit, $setLimit) {
        ...
        $query = "SELECT * FROM `product` $where LIMIT " . $pageLimit . " , " . $setLimit . "";
